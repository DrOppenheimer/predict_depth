...
if [ $# -eq 0 -o $# -gt 10 ]
then
    echo "DESCRIPTION: Shell wrapper for predict_depth.watstats.cross_assembly.r"
    echo 
    echo "USAGE: >predict_depth.sh <file_in> <col_nums> <num_reads> <file_out_prefix> <genome_size> <scale_by_unannotated> <read_length> <min_overlap> <produce_pdf> <show>"
    echo   
    ...
    echo
    echo "     <col_nums>:        DEFAULT = 1,2 ; comma sep list of column numbers to cross assemble"
